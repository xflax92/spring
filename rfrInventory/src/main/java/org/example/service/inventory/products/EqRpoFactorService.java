...
@Service
public class EqRpoFactorService extends FactorService {

    private String assetClassService = Const.EQ;
    private String factorTypeService = Const.RPO;
    ...
    public List<Factor> getInventorySCM(InventoryRequest req){
        RfInfo rfInfo = new RfInfo("EQ", "RPO", "SCM");
    ...
    public List<Factor> getInventoryOPE(InventoryRequest req){
        RfInfo rfInfo = new RfInfo("EQ", "RPO", "OPE");
        Factor factor = new Factor(new HeaderCtrl(), rfInfo, new RfBody());
        return Arrays.asList(factor);
    }
